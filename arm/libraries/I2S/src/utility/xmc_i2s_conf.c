...
XMC_I2S_t i2s_config = {
    ...
    .sclk_config = {.input_hysteresis = XMC_GPIO_INPUT_HYSTERESIS_STANDARD, .mode = XMC_GPIO_MODE_OUTPUT_PUSH_PULL_ALT1, .output_level = XMC_GPIO_OUTPUT_LEVEL_HIGH},
    .wa_config = {.input_hysteresis = XMC_GPIO_INPUT_HYSTERESIS_STANDARD, .mode = XMC_GPIO_MODE_OUTPUT_PUSH_PULL_ALT1, .output_level = XMC_GPIO_OUTPUT_LEVEL_HIGH},
