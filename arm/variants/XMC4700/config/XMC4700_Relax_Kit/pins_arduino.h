...
{
    /* 0  */    {XMC_GPIO_PORT2, 15}, 	// PIN_RX Serial1                 P2.15
    /* 1  */    {XMC_GPIO_PORT2 , 14}, 	// PIN_TX Serial1                 P2.14
	...
	/* 37  */   {XMC_GPIO_PORT0 , 5}, 	// I2C_1 SDA      			      P0.5
	...
	/* 67  */   {XMC_GPIO_PORT0 , 4}, 	//     			                  P0.4
	/* 68  */   {XMC_GPIO_PORT0 , 6}, 	// PWM                            P0.6
	/* 69  */   {XMC_GPIO_PORT0 , 11}, 	// I2C_1 SCL    			      P0.11
	...
	/* 77  */   {XMC_GPIO_PORT6 , 3}, 	// PIN_RX Serial1                 P6.3
	/* 78  */   {XMC_GPIO_PORT6 , 5}, 	// PWM                            P6.5
	/* 79  */   {XMC_GPIO_PORT1 , 15}, 	// PWM                            P1.15
	/* 80  */   {XMC_GPIO_PORT5 , 1}, 	//  		                      P5.1
	...
	/* 88  */   {XMC_GPIO_PORT5 , 0}, 	// 			                      P5.0
	/* 89  */   {XMC_GPIO_PORT6 , 6}, 	//                                P6.6
	/* 90  */   {XMC_GPIO_PORT6 , 4}, 	// PWM / PIN_TX Serial1           P6.4
	/* 91  */   {XMC_GPIO_PORT6 , 2}, 	// PWM                            P6.2
	/* 92  */   {XMC_GPIO_PORT6 , 0}, 	//                                P6.0
	/* 93  */   {XMC_GPIO_PORT0 , 8}, 	// 			                      P0.8
...
RingBuffer rx_buffer_additional;
RingBuffer tx_buffer_additional;
...
XMC_UART_t XMC_UART_additional =
{
    .channel              = XMC_UART0_CH1,
    .rx                   = {
        .port = (XMC_GPIO_PORT_t*)PORT6_BASE,
        .pin  = (uint8_t)3
    },
    .rx_config            = {
        .mode = XMC_GPIO_MODE_INPUT_TRISTATE,
    ...
    .input_source_dx0     = (XMC_USIC_INPUT_t)USIC0_C1_DX0_P6_3,
    .input_source_dx1     = XMC_INPUT_INVALID,
    .input_source_dx2     = XMC_INPUT_INVALID,
    .input_source_dx3     = XMC_INPUT_INVALID,
    .irq_num              = USIC0_1_IRQn,
    .irq_service_request  = 1
};
...
HardwareSerial Serial2(&XMC_UART_additional, &rx_buffer_additional, &tx_buffer_additional);
