 ...
 *******************************************************************************/
    ...
    ((OSCLP_MODE != OSCLP_MODE_POWER_DOWN) && (!defined(DISABLE_WAIT_RTC_XTAL_OSC_STARTUP)))
...
__WEAK void SystemCoreClockSetup(void) {
    ...
    do {
        ...
        /* According to errata SCU_CM.023, to reset the XOWD it is needed to disable/enable the
           watchdog, keeping in between at least one DCO2 cycle */
    ...
    SCU_CLK->CLKCR = (1023UL << SCU_CLK_CLKCR_CNTADJ_Pos) |
                     ...
                     (PCLK_CLOCK_SRC << SCU_CLK_CLKCR_PCLKSEL_Pos) | 0x100U; /* IDIV = 1 */
...
__WEAK void SystemCoreClockUpdate(void) {
    ...
    if (IDIV != 0) {
        ...
        if (((SCU_CLK->CLKCR1) & SCU_CLK_CLKCR1_DCLKSEL_Msk) == 0U) {
            ...
            SystemCoreClock = ((uint32_t)((OSCHP_GetFrequency() << 6U) / ((IDIV << 10) + FDIV)))
                              << 4U;
        }
    } else {
