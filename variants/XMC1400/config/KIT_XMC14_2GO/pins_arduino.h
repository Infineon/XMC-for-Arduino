...
#define NUM_LEDS 2
#define NUM_SERIAL 1
#define NUM_TONE_PINS 5 // PWM Pins
...
XMC_PWM4_t mapping_pwm4[] = {
    ...
    {CCU41, CCU41_CC40, 0, mapping_port_pin[9], P1_4_AF_CCU41_OUT0, XMC_CCU4_SLICE_PRESCALER_64,
     PWM4_TIMER_PERIOD, false} // PWM disabled  9    P1.4
};
