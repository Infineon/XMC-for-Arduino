...
const XMC_PORT_PIN_t mapping_port_pin[]=
    ...
    /* 26  */   {XMC_GPIO_PORT2, 8},    // GPIO / ETH_TXDO              P2.8                X1-35
    /* 27  */   {XMC_GPIO_PORT2, 4},    // GPIO / ETH_RXER              P2.4                X1-33
    /* 28  */   {XMC_GPIO_PORT2, 2},    // GPIO / ETH_RXDO              P2.2                X1-31
    /* 29  */   {XMC_GPIO_PORT2, 0},    // GPIO / ETH_MDIO              P2.0                X1-29
    /* 30  */   {XMC_GPIO_PORT2, 6},    // PWM8 -  / PWM / GPIO4_2GO_2  P2.6                X1-27
    /* 31  */   {XMC_GPIO_PORT5, 2},    // GPIO / RST                   P5.2                X1-25
    /* 32  */   {XMC_GPIO_PORT5, 0},    // GPIO1_2GO_1                  P5.0                X1-23
    /* 33  */   {XMC_GPIO_PORT1, 14},   // GPIO / IO_1                  P1.14 Duplicate     X1-21
    ...
    /* 38  */   {XMC_GPIO_PORT1, 0},    // GPIO / External INT 0        P1.0  Duplicate     X1-11
    /* 39  */   {XMC_GPIO_PORT1, 8},    // GPIO / SPI-SCK               P1.8  Duplicate     X1-9
    /* 40  */   {XMC_GPIO_PORT1, 6},    // GPIO / IO_0                  P1.6  Duplicate     X1-7
    /* 41  */   {XMC_GPIO_PORT4, 0},    // GPIO / GPIO2_2GO_2           P4.0                X1-5
    /* 42  */   {XMC_GPIO_PORT2, 14},   // UART TX                      P2.14 Duplicate     X1-3
    /* 43  */   {XMC_GPIO_PORT2, 15},   // UART RX                      P2.15 Duplicate     X1-4
    /* 44  */   {XMC_GPIO_PORT4, 1},    // GPIO / IO_2                  P4.1  Duplicate     X1-6
    /* 45  */   {XMC_GPIO_PORT1, 7},    // GPIO / SPI_CS_2GO_2          P1.7 (Chip Select - Slot 2)   X1-8
    /* 46  */   {XMC_GPIO_PORT1, 9},    // SPI-MOSI / PWM41-2 / PWM5    P1.9  Duplicate     X1-10
    /* 47  */   {XMC_GPIO_PORT1, 1},    // GPIO1_2GO_2                  P1.1                X1-12
    /* 48  */   {XMC_GPIO_PORT1, 3},    // GPIO / QSPI_IO3              P1.3                X1-14
    /* 49  */   {XMC_GPIO_PORT1, 5},    // GPIO / QSPI_IO0              P1.5                X1-16
    /* 50  */   {XMC_GPIO_PORT1, 11},   // GPIO / QSPI_CS               P1.11               X1-18
    /* 51  */   {XMC_GPIO_PORT1, 13},   // GPIO / CAN_RX                P1.13               X1-20
    /* 52  */   {XMC_GPIO_PORT1, 15},   // USB Debug RX                 P1.15 Duplicate     X1-22
    /* 53  */   {XMC_GPIO_PORT5, 1},    // GPIO / ETH_INT               P5.1                X1-24
    /* 54  */   {XMC_GPIO_PORT5, 7},    // PWM8 -  / PWM                P5.7                X1-26
    /* 55  */   {XMC_GPIO_PORT2, 7},    // PWM8 -  / PWM  / ETH_MDC     P2.7                X1-28
    /* 56  */   {XMC_GPIO_PORT2, 1},    // SWV   ""DEBUG Do NOT Use **  P2.1                X1-30
    /* 57  */   {XMC_GPIO_PORT2, 3},    // AREF TODO: / ETH_RXD1        P2.3  Duplicate     X1-32
    /* 58  */   {XMC_GPIO_PORT2, 5},    // I2C Data - SDA / A4          P2.5 (Hardwired to A4) Duplicate  X1-34
    /* 59  */   {XMC_GPIO_PORT2, 9},    // PWM8 -  / PWM / ETH_TXD1     P2.9                X1-36
    /* 60  */   {XMC_GPIO_PORT15, 8},   // A16 / ETH_CLK                P15.8               X1-38

    //Additional pins for port X2 starting here
    /* 61  */   {XMC_GPIO_PORT14, 8},   // A14 / DAC 0 Output           P14.8               X2-33
    /* 62  */   {XMC_GPIO_PORT15, 2},   // A12 - ADC Input              P15.2 (INPUT ONLY)  X2-31
    /* 63  */   {XMC_GPIO_PORT14, 15},  // A11 - ADC Input              P14.15 (INPUT ONLY) X2-29
    /* 64  */   {XMC_GPIO_PORT15, 9},   // A17 - ADC Input / ETH_CRS    P15.9               X2-27
    /* 65  */   {XMC_GPIO_PORT14, 6},   // A6 / AN1_2GO_1 - ADC Input   P14.6 (INPUT ONLY)  X2-25
    /* 66  */   {XMC_GPIO_PORT14, 12},  // A8 / AN1_2GO_2 - ADC Input   P14.12 (INPUT ONLY) X2-23
    /* 67  */   {XMC_GPIO_PORT14, 14},  // A10 / ADC Input              P14.14 (INPUT ONLY) X2-21
    /* 68  */   {XMC_GPIO_PORT3, 0},    // I2C Clk SCL / A5 - ADC Input P3.0  (Hardwired to A5) Duplicate    X2-19
    /* 69  */   {XMC_GPIO_PORT3, 2},    // BUTTON2                      P3.2                X2-17
    /* 70  */   {XMC_GPIO_PORT0, 10},   // INT / GPIO3_2GO_1            P0.10               X2-15
    /* 71  */   {XMC_GPIO_PORT0, 1},    // INT                          P0.1                X2-13
    /* 72  */   {XMC_GPIO_PORT0, 3},    // INT / GPIO3_2GO_2            P0.3                X2-11
    /* 73  */   {XMC_GPIO_PORT0, 5},    // USB Debug TX                 P0.5  Duplicate     X2-9
    /* 74  */   {XMC_GPIO_PORT0, 11},   // PWM80-31 output / PWM3       P0.11 Duplicate     X2-7
    /* 75  */   {XMC_GPIO_PORT3, 3},    // PWM42-3 output / PWM1        P3.3  Duplicate     X2-5
    /* 76  */   {XMC_GPIO_PORT3, 5},    // CS_2GO_1                     P3.5 (Chip Select - Slot 1)    X2-3
    /* 77  */   {XMC_GPIO_PORT0, 7},    // LED2                         P0.7                X2-1
    /* 78  */   {XMC_GPIO_PORT0, 8},    // QSPI_CLK                     P0.8                X2-4
    /* 79  */   {XMC_GPIO_PORT3, 6},    // PWM42-0(PWM0)/ External INT 1 P3.6 Duplicate     X2-6
    /* 80  */   {XMC_GPIO_PORT3, 4},    // PWM42-2 output / PWM2        P3.4  Duplicate     X2-8
    /* 81  */   {XMC_GPIO_PORT0, 12},   // CS_MB                        P0.12               X2-10
    /* 82  */   {XMC_GPIO_PORT0, 6},    // LED1                         P0.6                X2-12
    /* 83  */   {XMC_GPIO_PORT0, 4},    // ETH_TXEN                     P0.4                X2-14
    /* 84  */   {XMC_GPIO_PORT0, 2},    // SPI-CS / PWM80-01 / PWM4     P0.2  Duplicate     X2-16
    /* 85  */   {XMC_GPIO_PORT0, 0},    // SPI-MISO                     P0.0  Duplicate     X2-18
    /* 86  */   {XMC_GPIO_PORT0, 9},    // GPIO4_2GO_1 / PWM80-01 / PWM P0.9                X2-20
    /* 87  */   {XMC_GPIO_PORT3, 1},    // BUTTON1                      P3.1                X2-22
    /* 88  */   {XMC_GPIO_PORT14, 4},   // A4 - ADC Input / SDA         P14.4 (Hardwired to SDA) Duplicate    X2-24
    /* 89  */   {XMC_GPIO_PORT14, 13},  // A9 / AN2_2GO_2 - ADC Input   P14.13 (INPUT ONLY) X2-26
    /* 90  */   {XMC_GPIO_PORT14, 7},   // A7 / AN2_2GO_1 - ADC Input   P14.7 (INPUT ONLY)  X2-28
    /* 91  */   {XMC_GPIO_PORT14, 5},   // A5 - ADC Input / SCL         P14.5 (Hardwired to SCL) Duplicate    X2-30
    /* 92  */   {XMC_GPIO_PORT14, 3},   // A3 - ADC Input               P14.3 Duplicate     X2-32
    /* 93  */   {XMC_GPIO_PORT15, 3},   // A13 - ADC Input              P15.3 (INPUT ONLY)  X2-34
    /* 94  */   {XMC_GPIO_PORT14, 9}    // A15 / DAC 1 Output           P14.9               X2-36
    };
...
const uint8_t mapping_pin_PWM4[][ 2 ] = {
                                        ...
                                        { 5, 1 },   // PWM1
                                        { 6, 2 },   // PWM2
                                        { 11, 3 },  // PWM5 Actually does pin 27
                                        { 27, 4 },  // PWM  Actually does pin 28
                                        { 28, 5 },  // PWM  Actually does pin 57
                                        { 57, 6 },  // PWM  Actually does pin 58
                                        { 58, 7 },  // PWM  Actually does INVALID DATA of end of array
                                        { 255, 255 } };
...
const uint8_t mapping_pin_PWM8[][ 2 ] = {
                                        { 9,  0 },  // PWM3
                                        { 10, 1 },  // PWM4
                                        { 26, 2 },  // PWM  Actually does pin 55
                                        { 29, 3 },  // PWM  Actually does pin 86
                                        { 30, 4 },  // PWM  Actually does pin 30
                                        { 54, 5 },  // PWM  Actually does pin 39
                                        { 55, 6 },  // PWM  Actually does pin 26
                                        { 59, 7 },  // PWM  Actually does pin 54
                                        { 86, 8 },  // PWM  Actually does pin 29
                                        { 255, 255 } };
