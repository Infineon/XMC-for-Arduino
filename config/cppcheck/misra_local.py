...
class MisraChecker:
    ...
    def parseDump(self, dumpfile, path_premium_addon=None):
        ...
        self.printStatus('1', self.is_cpp)
...
def main():
    ...
    # args.rule_texts = "/home/jensb/pull_requests/3d_magnetic/magnetic-3d-sensor-tlx493d/misra.txt"
    if not args.rule_texts:
        args.rule_texts = os.environ.get('RULE_TEXTS')
