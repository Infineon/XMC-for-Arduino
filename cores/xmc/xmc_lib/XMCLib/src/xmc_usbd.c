 ...
 */
static uint32_t XMC_USBD_EP_OUT_BUFFERSIZE[7] = {0U, 0U, 0U, 0U, 0U, 0U, 0U};
/*
 * Endpoint In Fifo Size
 */
static uint32_t XMC_USBD_EP_IN_BUFFERSIZE[7] = {0U, 0U, 0U, 0U, 0U, 0U, 0U};
/*
 * Device definition
 */
...
#endif
static XMC_USBD_t *usbd_init;

/*******************************************************************************
 *LOCAL ROUTINES
 *******************************************************************************/
/*Local routines prototypes*/
static uint8_t XMC_USBD_lDeviceActive(const XMC_USBD_t *const obj);
