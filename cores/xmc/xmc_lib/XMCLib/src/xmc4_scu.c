...
void XMC_SCU_HIB_ClearEventStatus(int32_t event)
{
  ...
  SCU_HIBERNATE->HDCLR = (uint32_t)event;
}
...
void XMC_SCU_HIB_TriggerEvent(int32_t event)
{
  ...
  SCU_HIBERNATE->HDSET = (uint32_t)event;
}
...
void XMC_SCU_HIB_EnableEvent(int32_t event)
{
  ...
  SCU_HIBERNATE->HDCR |= (uint32_t)event;
}
...
void XMC_SCU_HIB_SetSR1Input(XMC_SCU_HIB_SR1_INPUT_t input)
{
  ...
  SCU_HIBERNATE->HDCR = (SCU_HIBERNATE->HDCR & (uint32_t)~(SCU_HIBERNATE_HDCR_GPI1SEL_Msk | SCU_HIBERNATE_HDCR_ADIG1SEL_Msk | SCU_HIBERNATE_HDCR_XTALGPI1SEL_Msk)) |
                        input;
}
#endif
