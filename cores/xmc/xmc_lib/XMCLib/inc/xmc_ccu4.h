...
{
  XMC_CCU4_SLICE_STATUS_BIT_PASSIVE = false, /**< Passive */
  XMC_CCU4_SLICE_STATUS_BIT_ACTIVE  = true   /**< Active  */
 ...
 *
 */
__STATIC_INLINE XMC_CCU4_SLICE_STATUS_BIT_t XMC_CCU4_GetSliceStatusBit(XMC_CCU4_MODULE_t *const module, uint8_t slice_number)
{
  return (XMC_CCU4_SLICE_STATUS_BIT_t)((module->GCST & (CCU4_GCST_CC40ST_Msk << slice_number)) ? 1 : 0);
}
