...
{
  volatile uint32_t status;                 /**< DMA descriptor status */
  volatile uint32_t length;                 /**< Descriptor length */
  volatile uint32_t buffer1;                /**< Buffer 1 */
  volatile uint32_t buffer2;                /**< Buffer 2 */
  volatile uint32_t extended_status;        /**< Extended status */
  volatile uint32_t reserved;               /**< Reserved */
  volatile uint32_t time_stamp_nanoseconds; /**< Time stamp low */
  volatile uint32_t time_stamp_seconds;     /**< Time stamp high */
 ...
 * MAC_ADDRESS0_LOW registers.
 */
void XMC_ETH_MAC_SetAddressEx(XMC_ETH_MAC_t *const eth_mac, const uint8_t *const addr);
 ...
 * The function checks if the TX descriptor is owned by the DMA.
 */
__STATIC_INLINE bool XMC_ETH_MAC_IsTxDescriptorOwnedByDmaEx(XMC_ETH_MAC_t *const eth_mac, uint8_t index)
{
  return ((eth_mac->tx_desc[index].status & ETH_MAC_DMA_TDES0_OWN) != 0U);
}
 ...
 */
__STATIC_INLINE uint8_t XMC_ETH_MAC_GetCurrentTxDescIndex(XMC_ETH_MAC_t *const eth_mac)
{
  return eth_mac->tx_index;
}
 ...
 * Returns the current TX buffer.
 */
__STATIC_INLINE uint8_t XMC_ETH_MAC_GetCurrentRxDescIndex(XMC_ETH_MAC_t *const eth_mac)
{
  return eth_mac->rx_index;
}
 ...
 * Returns the current TX buffer.
 */
__STATIC_INLINE uint8_t *XMC_ETH_MAC_GetTxBufferEx(XMC_ETH_MAC_t *const eth_mac, uint8_t index)
{
  return (uint8_t *)(eth_mac->tx_desc[index].buffer1);
}

/**
 * @param eth_mac A constant pointer to XMC_ETH_MAC_t, pointing to the ETH MAC base address
 * @param addresss Buffer address
 * @return None
 *
 * \par<b>Description: </b><br>
 * Sets the buffer address of the current TX buffer.
 */
__STATIC_INLINE void XMC_ETH_MAC_SetTxBuffer(XMC_ETH_MAC_t *const eth_mac, const uint8_t *const address)
{
  eth_mac->tx_desc[eth_mac->tx_index].buffer1 = (uint32_t)address;
}
 ...
 * Sets the buffer address of the current TX buffer.
 */
__STATIC_INLINE void XMC_ETH_MAC_SetTxBufferEx(XMC_ETH_MAC_t *const eth_mac, uint8_t index, const uint8_t *const address)
{
  eth_mac->tx_desc[index].buffer1 = (uint32_t)address;
}
 ...
 * Sets the buffer address of the current TX buffer.
 */
__STATIC_INLINE void XMC_ETH_MAC_SetRxBuffer(XMC_ETH_MAC_t *const eth_mac, const uint8_t *const address)
{
  eth_mac->rx_desc[eth_mac->rx_index].buffer1 = (uint32_t)address;
}
 ...
 * Sets the buffer address of the current TX buffer.
 */
__STATIC_INLINE void XMC_ETH_MAC_SetRxBufferEx(XMC_ETH_MAC_t *const eth_mac, uint8_t index, const uint8_t *const address)
{
  eth_mac->rx_desc[index].buffer1 = (uint32_t)address;
}
 ...
 * Sets the current TX buffer size.
 */
__STATIC_INLINE void XMC_ETH_MAC_SetTxBufferSizeEx(XMC_ETH_MAC_t *const eth_mac, uint8_t index, uint32_t size)
{
  eth_mac->tx_desc[index].length = size;
}
 ...
 */
void XMC_ETH_MAC_SetVLANTag(XMC_ETH_MAC_t *const eth_mac, uint32_t tag);
