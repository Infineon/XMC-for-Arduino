 ...
 *
 * \par<b>Note: </b><br>
 * Alternative to XMC_FCE_CalculateCRC16() where a uint8_t data array can be used
 */
 ...
 *
 * \par<b>Note:</b><br>
 * Alternative to XMC_FCE_CalculateCRC32() where a uint8_t data array can be used
 */
