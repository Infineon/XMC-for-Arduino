 ...
 */
typedef enum XMC_CCU8_SLICE_STATUS_BIT
{
  XMC_CCU8_SLICE_STATUS_BIT_PASSIVE = false, /**< Passive */
  XMC_CCU8_SLICE_STATUS_BIT_ACTIVE  = true   /**< Active  */
} XMC_CCU8_SLICE_STATUS_BIT_t;
 ...
 *
 */
__STATIC_INLINE XMC_CCU8_SLICE_STATUS_BIT_t XMC_CCU8_GetSliceStatusBit(XMC_CCU8_MODULE_t *const module, uint8_t slice_number, XMC_CCU8_SLICE_COMPARE_CHANNEL_t channel)
{
  return (XMC_CCU8_SLICE_STATUS_BIT_t)((module->GCST & ((CCU8_GCST_CC80ST1_Msk << slice_number) << (channel * CCU8_GCST_CC80ST2_Pos))) ? 1 : 0);
}
