 ...
 */
typedef enum XMC_BCCU_BCLK_MODE
{
 ...
 */
typedef enum XMC_BCCU_TRIGMODE
{
 ...
 */
typedef enum XMC_BCCU_TRIGDELAY
{
 ...
 */
typedef enum XMC_BCCU_SUSPEND_MODE
{
  ...
  XMC_BCCU_SUSPEND_MODE_SAFE_FREEZE = 2U, /**< All running channels gets stopped, and freeze into a last state (with safe stop) */
} XMC_BCCU_SUSPEND_MODE_t;

/**
 * Provides the options to select trap edge
 */
typedef enum XMC_BCCU_TRAPEDGE
{
 ...
 * The members can be combined using 'OR' operator for multiple selection.<br>
 */
typedef enum XMC_BCCU_EVENT_STATUS
{
 ...
 */
typedef enum XMC_BCCU_TRAP_STATUS
{
 ...
 */
typedef enum XMC_BCCU_TRAP_LEVEL
{
 ...
 */
typedef enum XMC_BCCU_CH_FLICKER_WD
{
 ...
 */
typedef enum XMC_BCCU_CH_GATING_FUNC
{
 ...
 */
typedef enum XMC_BCCU_CH_DIMMING_ENGINE_BYPASS
{
 ...
 */
typedef enum XMC_BCCU_CH_ACTIVE_LEVEL
{
 ...
 */
typedef enum XMC_BCCU_CH_TRIG_EDGE
{
 ...
 */
typedef enum XMC_BCCU_CH_TRAP_IN
{
 ...
 */
typedef enum XMC_BCCU_CH_TRAP_EDGE
{
 ...
 */
typedef enum XMC_BCCU_CH_TRIGOUT
{
 ...
 */
typedef enum XMC_BCCU_CH_DIMMING_SOURCE
{
 ...
 */
typedef enum XMC_BCCU_DIM_CURVE
{
