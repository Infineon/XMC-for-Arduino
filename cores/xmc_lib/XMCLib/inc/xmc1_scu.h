 ...
 * @note Only available in XMC1400 series
 */
typedef enum XMC_SCU_CLOCK_ADCCLKSRC
{
  XMC_SCU_CLOCK_ADCCLKSRC_48MHZ = 0UL << SCU_CLK_CLKCR1_ADCCLKSEL_Pos, /**< Internal oscillator DCO1 (48MHz) */
  XMC_SCU_CLOCK_ADCCLKSRC_32MHZ = 1UL << SCU_CLK_CLKCR1_ADCCLKSEL_Pos, /**< Internal oscillator DCO1 (48MHz) divided by 1.5 */
...
typedef enum XMC_SCU_IRQCTRL
{
  ...
  XMC_SCU_IRQCTRL_CAN0_SR4_IRQ20                 = (20U << 8U) | 2U, /**< @deprecated use instead XMC_SCU_IRQCTRL_CAN0_SR3_IRQ20 */
#endif
...
/**
 *
 * @param adcclk_src Clock source selected as external reference. @ref XMC_SCU_CLOCK_ADCCLKSRC_t
 *
 * @return None
 *
 * \par<b>Description</b><br>
