/**
 * RTC.cpp - Library for Arduino to control the RTC (Real Time Clock) of the XMC microcontroller
 * series.
 *
...
extern "C" {
#if (UC_FAMILY == XMC4)
void SCU_0_IRQHandler(void) { XMC_SCU_IRQHandler(0); }
#elif (UC_FAMILY == XMC1)
void SCU_1_IRQHandler(void) { XMC_SCU_IRQHandler(1); }
#endif
...
uint32_t RTCClass::getPrescaler() { return XMC_RTC_GetPrescaler(); }
