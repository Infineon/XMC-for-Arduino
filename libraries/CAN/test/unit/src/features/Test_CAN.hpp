...
void test_CAN_msg_tx_initialization(void)
{
    ...
    TEST_ASSERT_EQUAL_UINT32(XMC_CAN_FRAME_TYPE_STANDARD_11BITS, txMessage->can_id_mode); // Standard 11-bit identifier
...
void test_CAN_msg_rx_initialization(void)
{
    ...
    TEST_ASSERT_EQUAL_UINT32(XMC_CAN_FRAME_TYPE_STANDARD_11BITS, rxMessage->can_id_mode); // Standard 11-bit identifier
    ...
    TEST_ASSERT_EQUAL_UINT32(0U, rxMessage->can_ide_mask); // receive both standard and extended frames
